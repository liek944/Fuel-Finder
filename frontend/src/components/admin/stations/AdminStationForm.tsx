...
const AdminStationForm: React.FC<AdminStationFormProps> = ({
  editFormData,
  setEditFormData,
  editSubmitting,
  onSave,
          ...
          >
            <input
              ...
              onChange={(e) =>
                setEditFormData({
                  ...editFormData,
                  fuel_prices: (editFormData.fuel_prices || []).map(
                    (p: any, i: number) => (i === idx ? { ...p, fuel_type: e.target.value } : p),
                  ),
                })
              }
            ...
            <input
              ...
              onChange={(e) =>
                setEditFormData({
                  ...editFormData,
                  fuel_prices: (editFormData.fuel_prices || []).map(
                    (p: any, i: number) => (i === idx ? { ...p, price: e.target.value } : p),
                  ),
                })
              }
              style={{ padding: 4, fontSize: 11 }}
